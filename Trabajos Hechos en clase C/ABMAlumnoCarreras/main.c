...
int menuInforme();
void mostarInformes(eAlumno alumnos[], int tam, eCarrera carreras[], int tamC);
...
int main()
{
    ...
    do
    {
        ...
        case 6:
            ...
            mostarInformes(lista, TAM, carreras, TAMC);
...
char sal = 'n';
            ...
            {
            case 1:
                printf("Selecionaste el 1\n");
                break;
            case 2:
                printf("Selecionaste el 2\n");
                break;
            case 3:
                printf("Selecionaste el 3\n");
                break;
            case 4:
                printf("Selecionaste el 4\n");
                break;
            case 5:
                printf("Selecionaste el 5\n");
                break;
            case 6:
                printf("Selecionaste el 6\n");
                break;
            case 7:
                printf("Selecionaste el 7\n");
                break;
            case 8:
                printf("Selecionaste el 8\n");
                break;
            case 9:
                printf("Desea salir?\n");
                scanf("%c", &sal);
...
void mostrarAlumnoUnaCarrera(eAlumno alum[], int tam, eCarrera carr, int tamC, int idCar)
{


    for(int i=0; i<tam; i++)
    {
        if(alum[i].idCarrera == idCar && isEmpty == 0){
            mostrarCarrera(alum[i], carr, tamC)
        }
    }
